...
bool
DuckdbDriver::DoDelivery(TpccContextPtr& context) {
...
bool
DuckdbDriver::DoNewOrder(TpccContextPtr& context) {
...
bool
DuckdbDriver::DoPayment(TpccContextPtr& context) {
...
bool
DuckdbDriver::DoOrderStatus(TpccContextPtr& context) {
...
bool
DuckdbDriver::DoStockLevel(TpccContextPtr& context) {
...
void
DuckdbDriver::ForceRollBack(TpccContextPtr& context) {
    this->conn_->Rollback();
